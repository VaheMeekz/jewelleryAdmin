...
import {getWishBannerThunk} from "../../store/actions/bannersActions";
...
const WishBanner = () => {
    ...
    const data = useSelector(state => state.bannersReducer.wish)
    ...
    return (
        <Box m={2}>
            <h2 mt={3} mb={3}>Wish list banner</h2>
            <Box>
                {
                    openSection ? (
