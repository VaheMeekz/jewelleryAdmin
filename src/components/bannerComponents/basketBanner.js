...
import {getBannerBannerThunk} from "../../store/actions/bannersActions";
...
const BasketBanner = () => {
    ...
    const data = useSelector(state => state.bannersReducer.basket)
    ...
    const handleSubmit = () => {
        if (thisImg !== null) {
            axios
                .post(
                    `${baseUrl}/basketBanner/editImage`,
                    {
                        image: thisImg,
                    },
                    {
