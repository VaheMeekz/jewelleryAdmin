...
import {getDeleveryBannerThunk} from "../../store/actions/bannersActions";
...
const DeleveryBanner = () => {
    const dispatch = useDispatch()
    const [value, setValue] = useState(0);
    const data = useSelector(state => state.bannersReducer.delevery)
    ...
    useEffect(() => {
        dispatch(getDeleveryBannerThunk())
    }, [])
