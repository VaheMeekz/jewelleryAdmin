...
import {getTermsBannerThunk} from "../../store/actions/bannersActions";
...
const TermsBanner = () => {
    ...
    const data = useSelector(state => state.bannersReducer.terms)
    ...
    useEffect(() => {
        ...
        setImage(data && data.bannerImage)
    }, [data])
    ...
    return (
        <Box m={2}>
            ...
            <Box m={2}>
                ...
                <Button  color="secondary" color="secondary" style={{margin: "-25px 0 0 20px"}} variant="contained" onClick={handleOpen}>Edit</Button>
            </Box>
            <Modal
                open={open}
                onClose={handleClose}
                    ...
                    <div className="imageArea">
                        <div>
                            <div className="uploadBtns">
                                <Button color="secondary"  color="secondary" variant="contained" component="label">
                                    Upload
